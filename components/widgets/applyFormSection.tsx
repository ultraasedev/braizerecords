    ...
    <section className="relative text-white py-12 px-4">
      ...
      <div className="relative container mx-auto">
        <div className="text-center py-6">
          <h1 className="text-4xl md:text-4xl lg:text-4xl font-black bg-clip-text text-transparent bg-gradient-to-r from-red-700 to-orange-600 uppercase">
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6 p-6 bg-white text-black rounded-lg shadow-md">
          <div>
