...
const ServiceSection = () => {
  return (
    <section
      ...
      style={{ backgroundImage: 'url("https://conversationsabouther.net/wp-content/uploads/2018/08/queen.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}
    >
      <div className="container mx-auto px-4">
        <div className="text-center py-8 mb-6">
          <h1 className="text-2xl xs:text-2xl sm:text-2xl md:text-4xl lg:text-4xl font-bold text-white">
            LABELS & SERVICES
          </h1>
        ...
        <div className="bg-black/30 backdrop-blur-md rounded-lg flex flex-col md:flex-row items-center w-full mb-8 shadow-lg hover:shadow-xl transition-shadow duration-200">
          <Image
            src="/servsection/svs_01.png"
            alt="Braize Records"
            className="w-full md:w-1/2 rounded-lg transform hover:scale-105 transition-transform duration-200"
            width={100}
            height={75}
          />
          <div className="p-10">
