...
const Footer = () => {
  return ( 
    <footer className="relative bg-black text-white w-full border-t-red py-10">
      <div className="mx-auto px-4">
        {/* Section d'inscription à la newsletter avec un fond rouge */}
        <div className="bg-red-500 p-6 rounded-lg shadow-md text-center mb-8">
          <h2 className="text-2xl mb-2 font-bold">INSCRIVEZ-VOUS À NOTRE NEWSLETTER</h2>
          <p className="mb-4">Restez informés de nos actualités et celles de nos artistes</p>
